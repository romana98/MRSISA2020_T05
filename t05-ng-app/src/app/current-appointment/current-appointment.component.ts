          ...
          res => {
            ...
            this.http.post(url2, this.dataSource.data).subscribe(
              res => {
                ...
                let booleanPromise = this.r.navigate(["../addAnotherAppointment"], { queryParams: { app_id: this.modelApp.id, name: this.patient, email: this.router.snapshot.queryParamMap.get('email')} , relativeTo: this.router });
